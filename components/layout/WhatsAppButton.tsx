...
const whatsappHref =
  "https://wa.me/6281234567890?text=Halo%20Valdo,%20saya%20tertarik%20dengan%20layanan%20Solusi%20Digital...";
...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-[70] inline-flex items-center gap-3 rounded-full border border-emerald-300 bg-emerald-500 px-5 py-3 font-label text-xs font-bold uppercase tracking-[0.16em] text-white shadow-[0_14px_40px_rgba(16,185,129,0.35)]"
    >
